...
ggplot(data = diamonds) +
  geom_bin2d(mapping = aes(y = price, x = carat))
...
ggplot(data = diamonds) +
  geom_bin2d(mapping = aes(y = price, x = carat)) +
  scale_y_log10()
# Making x and y channels scal logarithmically shifts in the respective direction
...
ggplot(data = diamonds.sample) +
  geom_point(mapping = aes(y = price, x = carat)) +
